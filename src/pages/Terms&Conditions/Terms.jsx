	...
	return (
		<Layout>
			<div className='terms'>
				...
				<p>Last updated: October 04, 2020</p>
				...
				<ul>
					...
					<li>
						<p>
							...
							&quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to MacaronCorner.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							...
							of the Service. This Terms and Conditions agreement has been created with the help of the{' '}
					...
					<li>
						<p>
							<strong>Website</strong> refers to MacaronCorner, accessible from{' '}
							<a href='http://www.MacaronCorner.com' rel='external nofollow noopener'>
								http://www.MacaronCorner.com
							</a>
						</p>
					</li>
					<li>
				...
				<ul>
					<li>By email: stefan_gruescu@yahoo.com</li>
				</ul>
			</div>
		</Layout>
	);
